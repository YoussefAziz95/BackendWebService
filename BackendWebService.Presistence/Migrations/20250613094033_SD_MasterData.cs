    ...
    public partial class SD_MasterData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "FileLog",
                columns: new[] { "Id", "FullPath", "FileName", "Extention", "FileType", "CreatedBy", "CreatedDate", "IsActive", "IsDeleted", "IsSystem"},
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Address",
                columns: new[] { "Id","FullAddress", "Street", "City", "State", "Zone","CreatedBy", "CreatedDate", "IsActive", "IsDeleted", "IsSystem", "IsAdministration" },
                values: new object[,]
                {
                    { 1,"45 Engine Blvd, Stuttgart, Germany Stuttgart Baden-Württemberg Germany", "45 Engine Blvd, Stuttgart, Germany", "Stuttgart", "Baden-Württemberg", "Germany", "System", DateTime.Now, true, false, true , false},
                    { 2,"78 Brake Street, Milan, Italy","78 Brake Street", "Milan", "Lombardy", "Italy","System", DateTime.Now, true, false, true , false}
                });
            ...
            values: new object[,]
            {
                    ...
                    { (int)RoleEnum.Employee, Enum.GetName(typeof(RoleEnum), RoleEnum.Employee), Enum.GetName(typeof(RoleEnum), RoleEnum.Employee), "EMPLOYEE", null, null, true, "System", DateTime.Now, true, false },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    },
                    {
                        ...
                        DateTime.UtcNow, 3, "Tech", "Lead Employee", 4, "System",
                        null, null, true, hasher.HashPassword(null, "SuperAdmin@123"), Guid.NewGuid().ToString(), Guid.NewGuid().ToString(),
                        true, false, null, false, 0
                    },
                    {
