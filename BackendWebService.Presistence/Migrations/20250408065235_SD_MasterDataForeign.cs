...
namespace BackendWebService.Persistence.Migrations
{
    ...
    public partial class SD_MasterDataForeign : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Service",
                columns: new[] { "Id", "Name", "Code", "CategoryId", "CreatedBy", "CreatedDate", "IsActive", "IsDeleted", "IsSystem" },
                values: new object[,]
                {
                    { 1, "Engine Diagnosis", "ENG-DIAG-001", 1, "System", DateTime.Now, true, false, true },
                    { 2, "Oil Change", "LUB-OIL-002", 11, "System", DateTime.Now, true, false, true },
                    { 3, "Brake Pad Replacement", "BRK-PAD-003", 9, "System", DateTime.Now, true, false, true },
                    { 4, "Tire Rotation", "TIR-ROT-004", 3, "System", DateTime.Now, true, false, true },
                    { 5, "Battery Replacement", "BAT-RPL-005", 12, "System", DateTime.Now, true, false, true },
                    { 6, "Exhaust System Inspection", "EXH-INSP-006", 7, "System", DateTime.Now, true, false, true },
                    { 7, "Winter Tire Installation", "WIN-TIR-007", 10, "System", DateTime.Now, true, false, true },
                    { 8, "Spark Plug Replacement", "ENG-SPK-008", 8, "System", DateTime.Now, true, false, true },
                    { 9, "ABS Diagnostics", "BRK-ABS-009", 2, "System", DateTime.Now, true, false, true },
                    { 10, "Motor Oil Top-up", "LUB-MOT-010", 11, "System", DateTime.Now, true, false, true },
                    { 11, "Electrical Fault Repair", "ELE-FLT-011", 5, "System", DateTime.Now, true, false, true },
                    { 12, "High Performance Engine Tuning", "ENG-TUNE-012", 8, "System", DateTime.Now, true, false, true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, (int)RoleEnum.Customer, 10, "1234567890", false, 1, true, "System", DateTime.Now, true, false },
                    { 2, (int)RoleEnum.Customer, 11, "0987654321", true, 1, true, "System", DateTime.Now, true, false },
                    { 3, (int)RoleEnum.Customer, 12, "1122334455", false, 0, true, "System", DateTime.Now, true, false },
                    { 4, (int)RoleEnum.Customer, 13, "2233445566", true, 1, true, "System", DateTime.Now, true, false },
                    { 5, (int)RoleEnum.Customer, 14, "3564556677", false, 2, true, "System", DateTime.Now, true, false },
                    { 6, (int)RoleEnum.Customer, 15, "3344556677", false, 1, true, "System", DateTime.Now, true, false },
                    { 7, (int)RoleEnum.Customer, 16, "4455667788", true, 0, true, "System", DateTime.Now, true, false },
                    { 8, (int)RoleEnum.Customer, 17, "5566778899", false, 1, true, "System", DateTime.Now, true, false },
                    { 9, (int)RoleEnum.Customer, 18, "6677889900", true, 1, true, "System", DateTime.Now, true, false },
                });
