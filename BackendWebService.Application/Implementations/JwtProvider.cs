...
{
    /// <summary>
    /// Services for generating JSON Web Tokens (JWT) for user authentication.
    /// </summary>
    public sealed class JwtProvider : IJwtProvider
    {
        private readonly IdentitySettings _jwtOptions;
        ...
        public JwtProvider(IOptions<IdentitySettings> jwtOptions,
        ...
        public async Task<string> Generate(User user)
        {
            ...
            var jwtSecurityToken = new JwtSecurityToken(
                ...
                claims: claims,
                expires: DateTime.Now.AddHours(_jwtOptions.ExpirationMinutes),
