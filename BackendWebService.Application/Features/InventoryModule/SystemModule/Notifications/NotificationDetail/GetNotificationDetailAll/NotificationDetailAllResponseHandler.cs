...
internal class NotificationDetailAllResponseHandler(IUnitOfWork unitOfWork) : ResponseHandler, IRequestHandler<NotificationDetailAllRequest, List<NotificationDetailAllResponse>>
{
