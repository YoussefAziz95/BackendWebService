...
public class CustomerPaymentMethodAllResponseHandler : ResponseHandler, IRequestHandler<CustomerPaymentMethodAllRequest, List<CustomerPaymentMethodAllResponse>>
{
