...
public class ActionObjectAllResponseHandler(IUnitOfWork unitOfWork) : ResponseHandler, IRequestHandler<ActionObjectAllRequest, List<ActionObjectAllResponse>>
{
