...
namespace Application.Implementations
{
    ...
    public class SupplierService : ResponseHandler, ISupplierService
    {
        ...
        private async Task<int> AddAsync(AddSupplierRequest request)
        {
            ...
            try
            {
                var subject = "Supplier " + supplier.Organization.Name + " Created";
        ...
        /// </summary>
        public async Task<IResponse<GetPaginatedSupplier>> GetPaginated(GetPaginatedRequest request)
        {
        ...
        public async Task<IResponse<GetPaginatedSupplier>> GetRegisterSuppliers(GetPaginatedRequest request)
        {
