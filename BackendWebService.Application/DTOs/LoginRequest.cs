...
public record LoginResponse(int Id, string FullName, string PhoneNumner, string Email, string Token, DateTime TokenExpiry, RoleEnum MainRole, string? Department, string? Title, bool IsActive);
