...
namespace Application.Validators.Users
{
    ...
    /// </summary>
    public sealed class CreateUserWithPasswordValidator : AbstractValidator<CreateUserWithPasswordRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateUserWithPasswordValidator"/> class.
        /// </summary>
        public CreateUserWithPasswordValidator()
        {
