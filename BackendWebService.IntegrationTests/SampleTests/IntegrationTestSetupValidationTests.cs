...
namespace BackendWebService.IntegrationTests.SampleTests;

/// <summary>
/// Sample tests to validate integration test setup
/// </summary>
public class IntegrationTestSetupValidationTests
{
    [Fact]
